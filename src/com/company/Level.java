...
private levels selectedlevel;
    ...
    Level(levels selectedlevel) {
        ...
        pwrupImages[0] = new ImageIcon("Data\\Power-ups\\paddleplus.png").getImage();
        pwrupImages[1] = new ImageIcon("Data\\Power-ups\\laser pwrup.png").getImage();
        pwrupImages[2] = new ImageIcon("Data\\Power-ups\\speedUP.png").getImage();
        pwrupImages[3] = new ImageIcon("Data\\Power-ups\\enemy.png").getImage();
        pwrupImages[4] = new ImageIcon("Data\\Power-ups\\Health.png").getImage();
        laserImage = new ImageIcon("Data\\Power-ups\\laiser.png").getImage();
