...
public class Menu implements MouseListener, MouseMotionListener, KeyListener {
    ...
    public Menu(int live_index,Ball ball,Paddle paddle){
        ...
        BackGround  = new ImageIcon("Data\\Screens\\layer_1__semi_final.png").getImage();
        settingBG   = new ImageIcon("Data\\Screens\\settings_BG.jpg").getImage();
        ...
        ballImage[0] = new ImageIcon("Data\\Balls\\BlueBall.png").getImage();
        ballImage[1] = new ImageIcon("Data\\Balls\\GreenBall.png").getImage();
        ballImage[2] = new ImageIcon("Data\\Balls\\PinkBall.png").getImage();
        ballImage[3] = new ImageIcon("Data\\Balls\\OrangeBall.png").getImage();

        paddleImage[0] = new ImageIcon("Data\\Paddles\\bluePaddle.png").getImage();
        paddleImage[1] = new ImageIcon("Data\\Paddles\\greenPaddle.png").getImage();
        paddleImage[2] = new ImageIcon("Data\\Paddles\\orangePaddle.png").getImage();
        paddleImage[3] = new ImageIcon("Data\\Paddles\\redPaddle.png").getImage();
