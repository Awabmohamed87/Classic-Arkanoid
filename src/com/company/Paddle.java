...
public class Paddle{
    ...
    Paddle(int GameWidth,int GameHeight){
        ...
        fixedPaddleImage[0] = new ImageIcon("Data\\Paddles\\blueLargePaddle.png").getImage();
        fixedPaddleImage[1] = new ImageIcon("Data\\Paddles\\greenLargePaddle.png").getImage();
        fixedPaddleImage[2] = new ImageIcon("Data\\Paddles\\orangeLargePaddle.png").getImage();
        fixedPaddleImage[3] = new ImageIcon("Data\\Paddles\\redLargePaddle.png").getImage();
